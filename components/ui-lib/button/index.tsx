...
const buttonStyle = tva({
  ...
  variants: {
    action: {
      ...
      positive:
        'bg-success-600 border-success-400 data-[hover=true]:bg-success-700 data-[hover=true]:border-success-500 data-[active=true]:bg-success-800 data-[active=true]:border-success-600 data-[focus-visible=true]:web:ring-indicator-info',
      negative:
