...
// app/(tabs)/jobOffers/[id].tsx
import React from 'react'
import { ScrollView, Share, Alert } from 'react-native'
import { useLocalSearchParams, useRouter } from 'expo-router'
import { Box, VStack, HStack, Heading, Text, Button, ButtonText, ButtonIcon, Icon, Divider } from '@/components/ui'
import {
  Calendar,
  DollarSign,
  MapPin,
      ...
      {offer && (
        <>
          <ScrollView className="flex-1">
            <VStack className="gap-4 p-4 pb-32">
              {/* HEADER CARD */}
                  ...
                  <HStack className="gap-3">
                    <Box className="bg-success-50 border border-success-200 rounded-xl p-4 flex-1">
                      <VStack className="gap-2">
                        ...
                        <VStack className="gap-0.5">
                          <Text className="text-success-900 font-bold text-lg">{offer.salary_From}</Text>
                          <Text className="text-success-700 text-sm">to</Text>
                          <Text className="text-success-900 font-bold text-lg">{offer.salary_To}</Text>
                        </VStack>
                      </VStack>
                    </Box>
                    ...
                    <Box className="bg-primary-50 border border-primary-200 rounded-xl p-4 flex-1">
                      <VStack className="gap-2">
                        ...
                        <VStack className="gap-1">
                          <Text className="text-primary-900 font-semibold text-xs">From:</Text>
                          <Text className="text-primary-900 font-bold text-sm">{offer.boarding}</Text>
                          <Text className="text-primary-900 font-semibold text-xs mt-1">To:</Text>
                          <Text className="text-primary-900 font-bold text-sm">{offer.duration}</Text>
                        </VStack>
                      </VStack>
                    </Box>
                  </HStack>
              ...
              <Box className="bg-white rounded-2xl p-5 shadow-sm">
                ...
                <VStack className="gap-4">
                  ...
                  <Box className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-xl px-4 py-4">
                    <VStack className="gap-2">
                      <HStack className="items-center gap-2">
                        <Icon as={Briefcase} className="text-white/80" size="sm" />
                  ...
                  {offer.requirements && (
                    <VStack className="gap-2">
                      <HStack className="items-center gap-2">
                        ...
                        <Text className="text-typography-900 text-sm font-bold uppercase tracking-wide">
                          Requirements
                        </Text>
                      </HStack>
